...
Dispatch multiple parallel read-only scout subagents (Explore-type when the
runtime has one) with disjoint scopes over the test suite and CI/CD workflows:
